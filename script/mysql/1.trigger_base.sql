...
BEGIN
  IF new.id_bf_department IS NULL
  THEN
...
BEGIN
  IF new.id_bf_department_rel IS NULL
  THEN
...
BEGIN
  IF new.id_bf_people_role_rel IS NULL
  THEN
...
BEGIN
  IF new.id_bf_doc_group IS NULL
  THEN
...
BEGIN
  IF new.id_bf_folder_doc_rel IS NULL
  THEN
...
BEGIN
  IF new.id_bf_role_folder_auth IS NULL
  THEN
