...
public class FolderAction extends BaseAction {
    ...
    public String modifyFolder(Document document) throws BizfwServiceException {
        People people = getLoginPeople();
    ...
    public String setRoleOfFolder(String folderId, @RequestParam(value = "roleIdList[]") List<String> roleIdList)
